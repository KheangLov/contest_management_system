...
class RoleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if (!config('backpack.permissionmanager.allow_role_create') || !backpack_user()->isAdminRole()) {
            $this->crud->denyAccess('create');
        }
        if (!config('backpack.permissionmanager.allow_role_update') || !backpack_user()->isAdminRole()) {
            $this->crud->denyAccess('update');
        }
        if (!config('backpack.permissionmanager.allow_role_delete') || !backpack_user()->isAdminRole()) {
