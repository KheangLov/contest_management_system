...
class PermissionCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if (!config('backpack.permissionmanager.allow_permission_create') || !backpack_user()->isAdminRole()) {
            $this->crud->denyAccess('create');
        }
        if (!config('backpack.permissionmanager.allow_permission_update') || !backpack_user()->isAdminRole()) {
            $this->crud->denyAccess('update');
        }
        if (!config('backpack.permissionmanager.allow_permission_delete') || !backpack_user()->isAdminRole()) {
